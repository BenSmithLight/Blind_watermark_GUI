...
# bwm1.embed('D:/Learn/大学课程/数字图像处理/课程设计/Source/GUI/UI/design/Pictures/teststr.png')


bwm1 = WaterMark(password_img=1, password_wm=1)
wm_extract = bwm1.extract('D:/Learn/大学课程/数字图像处理/课程设计/Source/GUI/UI/design/Pictures/teststr.png', mode='bit', wm_shape=6)
print(wm_extract)
# # 向图像添加水印
